...
/**
 * @title HttpExceptionEnum.java
 * @author liyuanguo
 * @time 2018年7月16日 下午5:30:48
 * @description TODO
 * @version V1.0
 */
...
public enum HttpExceptionEnum {
    ...
    FORBIDDEN(403, "Forbidden", "请求被理解，但是拒绝执行，权限不够"),
    ...
    HttpExceptionEnum(int code, String reasonPhraseUS, String reasonPhraseCN) {
        this.code = code;
    ...
    public static HttpExceptionEnum valueOf(int code) {
        for (HttpExceptionEnum httpStatus : values()) {
